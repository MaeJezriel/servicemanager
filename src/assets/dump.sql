...
INSERT or IGNORE INTO jobtable(id, service_request, location_name, tasks_name, time_name, site_equipment, problem_name) VALUES (1, 'I need a new set of equipment tools for creating coffee machine inside the warehouse.', 'Metro Manila', 'Coffee Maker Equipment',
'11:30-12:30pm', 'testing service request', 'dsdsd');
